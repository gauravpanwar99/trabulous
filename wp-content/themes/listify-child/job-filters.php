...
<?php
$jobs_listing_description = get_queried_object();   
if ( $jobs_listing_description && ! empty( $jobs_listing_description->description ) ) : ?>
    <div class="job-listing-description">
        <?php echo wpautop( $jobs_listing_description->description ); ?>
    </div>
<?php endif;  ?>
<form class="job_filters" id="jobFiltersResult">
	<?php echo listify_partial_search_filters_archive( false, $atts ); // WPCS: XSS ok. ?>
